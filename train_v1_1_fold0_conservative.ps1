param(
    ...
    [string]$WorkDir = ".\artifacts\training\rtmdet_tiny_mining6_fold0_conservative_ft_12e"
)
...
$Config = Join-Path $ProjectRoot "configs\models\rtmdet\rtmdet_tiny_mining6_fold0_conservative_ft_12e.py"
...
foreach ($Required in @(
    $Python, $TrainScript, $Config, $FoldRoot, $Annotations, $V1Checkpoint, $DatasetRoot
)) {
